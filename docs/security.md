...
| Return structurally valid outputs that fail TIG solution verification | Verification-pipeline congestion, fee loss, delayed useful benchmarks | The reserved precommit fee charged back (`accounting.md` §11.6), tier failure threshold, correlation breaker, semantic-screening experiment |
