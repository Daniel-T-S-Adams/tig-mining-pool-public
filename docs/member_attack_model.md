...
| M13 | Withdraw, reuse, transfer, or race security collateral while exposure remains | Leaves pool unable to recover a later loss | Atomically reserve finalized collateral; pending return grants no capacity; keep method reserve through report closure |
